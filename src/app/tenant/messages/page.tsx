          ...
          {threads.length === 0 ? (
            ...
            threads.map((t) => (
              ...
              >
                ...
                {t.unread && <span className="inline-block w-2 h-2 bg-[#234681] rounded-full mt-1" />}
              </button>
            ))
          )}
        </div>
          ...
          {!selectedThread ? (
            ...
            <>
              ...
              <div className="p-3 border-t flex gap-2">
                ...
                />
                <button onClick={handleSendReply} className="bg-[#d97706] text-white px-4 py-2 rounded text-sm hover:bg-[#b45309]">
                  Send
                </button>
              </div>
            </>
